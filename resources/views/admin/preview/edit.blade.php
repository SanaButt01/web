...
<body>
<div class="container">
    <h2>Edit Previews for Content: {{ $content_id }}</h2>
    @if(session('error'))
    ...
    <form id="editPreviewsForm" action="{{ route('admin.previews.update', $content_id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
