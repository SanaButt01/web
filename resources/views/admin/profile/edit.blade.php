    ...
    <div class="edit-profile">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 form-group input-group-square">
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i class="icofont icofont-user"></i></span></div>
            ...
            <div class="col-lg-8 card">
                <form class="" action="{{route('profile.update',['id' => $admin->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs border-tab nav-primary" id="info-tab" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="info-personal-tab" data-toggle="tab" href="#info-personal" role="tab" aria-controls="info-home" aria-selected="true"><i class="icofont icofont-businessman"></i>Personal</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="info-tabContent">
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="phone" class="form-control" type="tel" name="phone" value="{{$admin->phone}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="suite" value="{{$admin->suite}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="zip" value="{{$admin->zip}}">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="country_id" class="form-control" id="country_id">
                                    ...
                                    @else
                                    <option value="{{ $admin->country_id }}">{{ $admin->country->name }}</option>
                                    @endif
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend input-group-btn">
                                            <span class="input-group-text btn-file">
                                                ...
                                                <input type="file" accept=".jpg, .jpeg, .png, .gif" name="avatar" id="imgInp">
                                            </span>
                                        </div>
