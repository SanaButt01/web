...
@section('title', 'General widget | Endless - Premium Admin Template')
@section('style')
...
@section('breadcrumb-title', 'General widget')
@section('breadcrumb-items')
<li class="breadcrumb-item">Widgets</li>
<li class="breadcrumb-item active">General widget</li>
@endsection
...
<div class="container-fluid">
    <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 pl-0">
              <div class="media">
                ...
                <div class="media-body align-self-center"><i class="font-primary float-left ml-2" data-feather="layers"></i></div>
              </div>
            </div>
            <div class="col-sm-6 pr-0">
              <div class="media border-after-xs">
                ...
                <div class="media-body align-self-center"><i class="font-primary float-left ml-1" data-feather="shopping-cart"></i></div>
              </div>
            </div>
            <div class="col-sm-6 pl-0">
              <div class="media">
      ...
      <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 set-col-6">
            ...
            <div class="user-status table-responsive">
              <table class="table table-bordernone">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="bd-t-none u-s-tb">
                      <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle" src="{{asset('assets/images/user/1.jpg')}}" alt="">
                        <div class="d-inline-block">
      ...
      <div class="col-sm-12 col-lg-6 col-xl-4 xl-50 col-md-12 set-col-6">
      ...
      <div class="col-sm-12 col-lg-6 col-xl-8 xl-50 col-md-12 set-col-6">
        <div class="card height-equal">
          <div class="card-header">
            <h5>Contact Us</h5>
            <div class="card-header-right">
      ...
      <div class="col-xl-4 col-lg-12 set-col-12">
        <div>
          <div class="card">
            <div class="card-header">
          ...
          <div class="card-body">
            <div class="owl-carousel owl-theme" id="owl-carousel-testimonial">
              <div class="item"><i class="icon-quote-left"></i>
                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia</p><img class="img-80" src="{{asset('assets/images/dashboard/boy-2.png')}}" alt="">
