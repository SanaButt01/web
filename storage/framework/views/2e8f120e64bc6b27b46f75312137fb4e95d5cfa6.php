<!-- resources/views/widgets/dashboard_widgets.blade.php -->

<head>   <link rel="stylesheet" href="<?php echo e(asset('css/app.css')); ?>">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0"><?php echo e(categories); ?></h5>
...
</div><?php /**PATH F:\bookscity\resources\views/widgets/dashboard_widgets.blade.php ENDPATH**/ ?>