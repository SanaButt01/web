...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <ul>
        <li><a href="<?php echo e(route('book.index')); ?>">Add Books</a></li>
        <li><a href="<?php echo e(route('admin.viewbooks')); ?>">Users</a></li>
        <li><a href="<?php echo e(route('category.index')); ?>">show categories</a></li>
        
        <li><a href="<?php echo e(url('/Register/view')); ?>">Orders</a></li>
        <li><a href="<?php echo e(url('/Register/view')); ?>">Feedback</a></li>
        <li><a href="<?php echo e(url('/Register/view')); ?>">Link 3</a></li>
...
<?php /**PATH F:\bookscity\resources\views/admin/home.blade.php ENDPATH**/ ?>