    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <form action="<?php echo e(route('previews.destroy', $preview->content_id)); ?>" method="POST">
                <button type="button" class="btn btn-primary action-btn" onclick="window.location.href='<?php echo e(route('admin.previews.edit', $preview->content_id)); ?>'">
...
<?php /**PATH D:\sana_project\web\resources\views/admin/preview/index.blade.php ENDPATH**/ ?>