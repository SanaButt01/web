...
<body>
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            ...
            <!-- Brand -->
            <a class="h4 mb-0 text-uppercase d-none d-lg-inline-block custom-margin-left" href="<?php echo e(route('admin.dashboard')); ?>">
...
<?php /**PATH D:\sana_project\web\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>