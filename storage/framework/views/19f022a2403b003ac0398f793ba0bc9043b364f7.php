<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <img src="<?php echo e(asset('argon')); ?>/img/brand/logo2.png" class="navbar-brand-img" alt="..." style="width:30% !important; height:450px !important;">
                ...
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="<?php echo e(route('home')); ?>">
                            <img src="<?php echo e(asset('argon')); ?>/img/brand/logo2.png">
                        </a>
                    </div>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('category.index')); ?>">
                        <i class="ni ni-tv-2 text-primary"></i> <?php echo e(__('Categories')); ?>
...
<?php /**PATH F:\bookscity\resources\views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>