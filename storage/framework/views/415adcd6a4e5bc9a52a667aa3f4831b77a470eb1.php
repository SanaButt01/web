...
<div class="container">
    ...
    <form action="<?php echo e(route('disc.book.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
...
<?php /**PATH F:\bookscity\resources\views/admin/disc/create.blade.php ENDPATH**/ ?>