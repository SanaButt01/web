...
<body>
<div class="container">
    <h2>Edit Previews for Content: <?php echo e($content_id); ?></h2>
    ...
    <form id="editPreviewsForm" action="<?php echo e(route('admin.previews.update', $content_id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php /**PATH F:\bookscity\resources\views/admin/preview/edit.blade.php ENDPATH**/ ?>